...
@XmlRootElement(name = "UpBikeRequest")
public class UpBikeRequest {

    @XmlElement(name = "Header", required = true)
    protected HeaderType header;
    @XmlElement(name = "Body", required = true)
    protected UpBikeRequest.Body body;
     ...
     * @return
     *     possible object is
     *     {@link UpBikeRequest.Body }
     *     
     */
    public UpBikeRequest.Body getBody() {
        return body;
    }
     ...
     *     
     */
    public void setBody(UpBikeRequest.Body value) {
        this.body = value;
    }
