...
@XmlRootElement(name = "AddLocalRequest")
public class AddLocalRequest {

    @XmlElement(name = "Header", required = true)
    protected HeaderType header;
    @XmlElement(name = "Body", required = true)
    protected AddLocalRequest.Body body;
     ...
     * @return
     *     possible object is
     *     {@link AddLocalRequest.Body }
     *     
     */
    public AddLocalRequest.Body getBody() {
        return body;
    }
     ...
     *     
     */
    public void setBody(AddLocalRequest.Body value) {
        this.body = value;
    }
