...
@XmlRootElement(name = "RemoveAnuncioRequest")
public class RemoveAnuncioRequest {

    @XmlElement(name = "Header", required = true)
    protected HeaderType header;
    @XmlElement(name = "Body", required = true)
    protected RemoveAnuncioRequest.Body body;
     ...
     * @return
     *     possible object is
     *     {@link RemoveAnuncioRequest.Body }
     *     
     */
    public RemoveAnuncioRequest.Body getBody() {
        return body;
    }
     ...
     *     
     */
    public void setBody(RemoveAnuncioRequest.Body value) {
        this.body = value;
    }
