...
@XmlRootElement(name = "GetCiclistaRequest")
public class GetCiclistaRequest {

    @XmlElement(name = "Header", required = true)
    protected HeaderType header;
    @XmlElement(name = "Body", required = true)
    protected GetCiclistaRequest.Body body;
     ...
     * @return
     *     possible object is
     *     {@link GetCiclistaRequest.Body }
     *     
     */
    public GetCiclistaRequest.Body getBody() {
        return body;
    }
     ...
     *     
     */
    public void setBody(GetCiclistaRequest.Body value) {
        this.body = value;
    }
