...
@XmlRootElement(name = "UpdateCiclistaRequest")
public class UpdateCiclistaRequest {

    @XmlElement(name = "Header", required = true)
    protected HeaderType header;
    @XmlElement(name = "Body", required = true)
    protected UpdateCiclistaRequest.Body body;
     ...
     * @return
     *     possible object is
     *     {@link UpdateCiclistaRequest.Body }
     *     
     */
    public UpdateCiclistaRequest.Body getBody() {
        return body;
    }
     ...
     *     
     */
    public void setBody(UpdateCiclistaRequest.Body value) {
        this.body = value;
    }
